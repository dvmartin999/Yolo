...
TRAIN_CLASSES               = dir1+"/model_data/final_4class_inspected_names.txt" # also used for detection_custom.py
...
TRAIN_DATA_AUG              = True
TRAIN_TRANSFER              = True
TRAIN_FROM_CHECKPOINT       = False#"checkpoints/yolov3_custom"#False#"checkpoints/Training_7_class_100img"
TRAIN_LR_INIT               = 1e-4
TRAIN_LR_END                = 1e-6
